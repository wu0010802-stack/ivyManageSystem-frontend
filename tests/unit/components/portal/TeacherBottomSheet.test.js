...
describe('TeacherBottomSheet — basic render', () => {
  it('modelValue=false 時不渲染 dialog', () => {
    const wrapper = mount(TeacherBottomSheet, {
      ...mountOpts,
...
describe('TeacherBottomSheet — dismiss', () => {
...
describe('TeacherBottomSheet — a11y', () => {
...
describe('TeacherBottomSheet — snap points', () => {
...
describe('TeacherBottomSheet — drag gesture', () => {
...
describe('TeacherBottomSheet — keyboard mode', () => {
