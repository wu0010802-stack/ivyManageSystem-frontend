...
type BreakdownDay = { date: string; type: string; hours?: number; work_start?: string; work_end?: string; holiday_name?: string }

export function useLeaveHintFormatter({ form, calcBreakdown, leaveMode }: { form: { start_date?: string | null; end_date?: string | null }; calcBreakdown: Ref<BreakdownDay[]>; leaveMode: Ref<string> }) {
