...
<template>
  <div class="login-page">
    <main class="login-shell" :aria-label="`${branding.org_name}管理系統登入`">
    ...
    <footer class="login-footer">
      <p class="footer-tagline">{{ branding.org_name }} ・ 管理系統</p>
...
.brand-mark {
  ...
  background: url('/images/login-logo-512.png') center / contain no-repeat;
