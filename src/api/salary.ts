...
export const getEnrollmentSnapshot = (year: number, month: number): AxiosResp<'/salaries/enrollment-snapshot', 'get'> =>
    api.get(`/salaries/enrollment-snapshot?year=${year}&month=${month}`)

export const generateEnrollmentSnapshot = (payload: ApiBody<'/salaries/enrollment-snapshot/generate', 'post'>): AxiosResp<'/salaries/enrollment-snapshot/generate', 'post'> =>
    api.post('/salaries/enrollment-snapshot/generate', payload)

export const patchEnrollmentSnapshot = (id: number, payload: ApiBody<'/salaries/enrollment-snapshot/{snapshot_id}', 'patch'>): AxiosResp<'/salaries/enrollment-snapshot/{snapshot_id}', 'patch'> =>
    api.patch(`/salaries/enrollment-snapshot/${id}`, payload)

export const confirmEnrollmentSnapshot = (payload: ApiBody<'/salaries/enrollment-snapshot/confirm', 'post'>): AxiosResp<'/salaries/enrollment-snapshot/confirm', 'post'> =>
