...
const base = (studentId) => `/students/${studentId}/milestones`

export const listMilestones = (studentId, params = {}) =>
  api.get(base(studentId), { params })

export const createMilestone = (studentId, payload) =>
  api.post(base(studentId), payload)

export const updateMilestone = (studentId, id, payload) =>
