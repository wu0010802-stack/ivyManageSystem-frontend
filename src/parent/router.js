...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      meta: { title: '出席', tab: 'family' },
    },
    {
      path: '/announcements',
      name: 'parent-announcements',
      component: () => import('./views/AnnouncementsView.vue'),
      meta: { title: '公告', tab: 'family' },
    },
    {
      path: '/leaves',
      name: 'parent-leaves',
      component: () => import('./views/LeavesView.vue'),
      meta: { title: '請假', tab: 'family', showBack: true },
    },
    {
      path: '/messages',
