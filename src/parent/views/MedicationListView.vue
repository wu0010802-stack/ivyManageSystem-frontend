...
.new-btn { min-height: var(--touch-target-min, 44px); padding: 8px 14px; background: var(--brand-primary); color: var(--neutral-0); border: none; border-radius: var(--pt-control-radius, 12px); font-size: 14px; font-weight: 800; transition: background var(--transition-fast, 0.15s ease), transform var(--transition-fast, 0.15s ease); }
