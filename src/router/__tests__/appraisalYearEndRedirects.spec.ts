...
const CASES: Array<[string, string, Record<string, string>?]> = [
  ...
  ['/appraisal-management', '/appraisal-year-end/appraisal'],
  ['/appraisal/cycles', '/appraisal-year-end/appraisal', { stage: 'sign' }],
  ['/appraisal/cycles/12', '/appraisal-year-end/appraisal', { cycle: '12', stage: 'sign' }],
